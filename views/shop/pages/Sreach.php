<div class="col-md-10" style="border-left:  3px double white;">
	...
	foreach($data["sreach"] as $row){
		$t .="<div class='col-md-3' style='background:white;margin:4px 4px;width:24%;padding:60px;border-radius:1px;box-shadow:0px 5px 5px 0px rgba(0,0,0,0.3);min-height:500px;'>";
